...
export const clientSuccessIntro = {
  ...
  heading: ['Real partnerships.', 'Real impact.', 'Real business outcomes.'],
  description:
    'Every successful project is built on collaboration, innovation and measurable results. Explore how Stackneuro Solutions has helped organizations solve real business challenges.',
};
